      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="mt-6 text-lg font-medium text-gray-600">Loading your orders...</p>
          </div>
        ) : orders.length === 0 ? (
          // Empty State
          <div className="flex flex-col items-center justify-center py-20">
          ...
          <div className="space-y-4">
            {orders.map((order) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all p-6 border border-gray-100 group-hover:border-emerald-200">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-start gap-4 flex-1">
                      {/* Order Icon */}
                      <div className="w-14 h-14 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Status Badge */}
                        <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-semibold border ${getStatusColor(order.status)}`}>
