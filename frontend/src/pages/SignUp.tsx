...
import { ShoppingCart, User, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles } from "lucide-react";
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex flex-col justify-center p-12">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Create your account and start enjoying fresh groceries delivered to your doorstep in minutes.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Get access to member-only discounts</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">10-minute delivery guaranteed</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Hassle-free returns and refunds</p>
              </div>
            </div>
          </div>
        </div>
